/**********************************************************/
/*** Title: Lab4_BankAccount.cpp           				***/
/*** Developer: Santiago Sanchez						***/
/*** Date: 9/26/2022									***/
/*** Description: Meant to transfer funds between bank  ***/
/*** account classes									***/
/**********************************************************/
#include <iostream>
#include <iomanip>
...
int main() {
	...
	cout << Lindas_Accts;// Display Linda's Accounts

	// Pay Day #1 for Linda
	Lindas_Accts.DepositChecking(1450); //    -- Deposit $1450 to checking 
	Lindas_Accts.DepositSavings(800); //    -- Deposit $800 to savings
	Lindas_Accts.DisplayBalances();  //    -- Display Linda's Accounts (using DisplayBalances() function)

	// Pay Some Bills for Linda
	Lindas_Accts.WithdrawChecking(148.57);  //    -- Withdraw $148.57 from checking 
	Lindas_Accts.WithdrawChecking(208.79);//    -- Withdraw $208.79 from checking 
	Lindas_Accts.WithdrawChecking(1105.25);//    -- Withdraw $1105.25 from checking 
	cout << Lindas_Accts;//    -- Display Linda's Accounts (using the friend function)

	// Transfer Funds
	Lindas_Accts.TransferToSavings(850);  //    -- Transfer $850 from checking to savings
	Lindas_Accts.WithdrawSavings(575);  //    -- Withdraw $575 from savings
	cout << Lindas_Accts;  //    -- Display Linda's Accounts (using the friend function)
